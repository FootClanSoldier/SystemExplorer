...
public partial class SystemExplorerPlugin
{
    ...
    private void BuildDock()
    {
        ...
        _renameFolderConflictDialog = CreateFolderNameConflictDialog();
        _renameDialog.AddChild(_renameFolderConflictDialog);
        ...
        _addFolderConflictDialog = CreateFolderNameConflictDialog();
        _addFolderDialog.AddChild(_addFolderConflictDialog);

        _namespaceRefactorHost = new NamespaceRefactorPluginHost(
        ...
        _renameFolderConflictDialog.Confirmed += OnRenameFolderConflictDialogClosed;
        _renameFolderConflictDialog.Canceled += OnRenameFolderConflictDialogClosed;
        ...
        _dock.AddChild(_namespaceRefactorHost.Dialog);
        _dock.AddChild(_csharpierInstallResultDialog);
        _dock.AddChild(_csharpierNotInstalledDialog);
    }

    private static AcceptDialog CreateFolderNameConflictDialog()
    {
        return new AcceptDialog
        {
            Title = "Folder Already Exists",
            DialogText = "A folder with this name already exists.",
            OkButtonText = "OK",
