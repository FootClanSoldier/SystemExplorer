...
internal sealed class NamespaceRefactorFeature
{
	...
	private NamespaceRefactorDiagnosticTrace _diagnosticTrace;
	...
	)
	{
		...
		_isDebugEnabled = isDebugEnabled ?? throw new ArgumentNullException(nameof(isDebugEnabled));
	...
	private NamespaceRefactorDiagnosticTrace DiagnosticTrace =>
		_diagnosticTrace ??= new NamespaceRefactorDiagnosticTrace(_isDebugEnabled, _debugLog);

	private NamespaceRefactorProjectScopeCoordinator ProjectScopeCoordinator =>
		_projectScopeCoordinator ??=
			new NamespaceRefactorProjectScopeCoordinator(
	...
	private NamespaceRefactorOperationRequestCoordinator OperationRequestCoordinator =>
		_operationRequestCoordinator ??=
			new NamespaceRefactorOperationRequestCoordinator(
	...
	private NamespaceRefactorDialogOpeningCoordinator DialogOpeningCoordinator =>
		_dialogOpeningCoordinator ??=
			new NamespaceRefactorDialogOpeningCoordinator(
				_dialogView,
				DialogSessionState,
	...
	private NamespaceRefactorDialogRequestCoordinator DialogRequestCoordinator =>
		_dialogRequestCoordinator ??=
			new NamespaceRefactorDialogRequestCoordinator(
				ProjectScopeCoordinator,
	...
	private NamespaceRefactorDialogConfirmationCoordinator DialogConfirmationCoordinator =>
		_dialogConfirmationCoordinator ??=
			new NamespaceRefactorDialogConfirmationCoordinator(
				_dialogView,
				DialogSessionState,
				DiagnosticTrace,
