...
internal sealed class NamespaceRefactorPreparationResult
{
    ...
    )
    {
        ...
        List<string> result = paths?.Where(allowedPathSet.Contains).ToList() ?? new List<string>();
...
internal sealed class NamespaceRefactorPreparationService
{
    ...
    )
    {
        ...
        IReadOnlyList<string> normalizedDeclarationPaths = _scopeResolver.NormalizeScriptPaths(
    ...
    internal NamespaceRefactorNamespaceScanResult ScanNamespaces(IEnumerable<string> scriptPaths)
    {
