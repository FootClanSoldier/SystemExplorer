...
internal sealed class NamespaceRefactorDialogView
{
    ...
    internal void ConfigureBatch(IReadOnlyList<string> namespaces, bool hasScriptsWithoutNamespace)
    {
        if (namespaces == null)
    ...
    internal string GetSelectedExistingNamespace()
    {
        ...
        return selectedIndex >= 0 ? _existingNamespaceDropdown.GetItemText(selectedIndex) : "";
    }
